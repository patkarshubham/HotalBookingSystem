...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <div class="site-blocks-cover overlay" style="background-image: url(images/c-1.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-4">
            <div class="p-4 mb-3 bg-white">
              ...
              <p class="mb-0 font-weight-bold">Address Hotel Raj </p>
              <p class="mb-4">Near Lalbagh Road Sitapur, Lucknow , Mumbai,  Bengaluru in India</p>

              <p class="mb-0 font-weight-bold">Phone</p>
              <p class="mb-4"><a href="#">+91 99999 55555</a></p>

              <p class="mb-0 font-weight-bold">Email Address</p>
              <p class="mb-0"><a href="#">hotelraj4@gmail.com</a></p>
               <p class="mb-0 font-weight-bold">Website</p>
               <p class="mb-0"><a href="#">hotelraj.com</a></p>
