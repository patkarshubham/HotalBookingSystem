...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <div class="site-blocks-cover overlay" style="background-image: url(images/hero_4.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-4 mb-5">
            <div class="hotel-room text-center">
              <a href="#" class="d-block mb-0 thumbnail"><img src="images/room-1.jpg" alt="Image" class="img-fluid"></a>
              <div class="hotel-room-body">
                <h3 class="heading mb-0"><a href="#">Family Room</a></h3>
               <p><span class="price mr-2">720.00</span> <span class="per">per night</span></p>
		   <hr>
		 	<p class="pt-1"><a href="Reservation.jsp" class="btn-custom">Book Now <span class="icon-long-arrow-right"></span></a></p>
              </div>
            </div>
          </div>
            ...
            <div class="col-md-6 col-lg-4 mb-5">
            <div class="hotel-room text-center">
              <a href="#" class="d-block mb-0 thumbnail"><img src="images/room-2.jpg" alt="Image" class="img-fluid"></a>
              <div class="hotel-room-body">
                <h3 class="heading mb-0"><a href="#">Standard Room</a></h3>
                <strong class="price">1350.00 / per night</strong>
                <p class="pt-1"><a href="Reservation.jsp" class="btn-custom">Book Now <span class="icon-long-arrow-right"></span></a></p>
              </div>
            </div>
          </div>
            ...
            <div class="col-md-6 col-lg-4 mb-5">
            <div class="hotel-room text-center">
              <a href="#" class="d-block mb-0 thumbnail"><img src="images/room-3.jpg" alt="Image" class="img-fluid"></a>
              <div class="hotel-room-body">
            ...
            <div class="col-md-6 col-lg-4 mb-5">
            <div class="hotel-room text-center">
              <a href="#" class="d-block mb-0 thumbnail"><img src="images/room-4.jpg" alt="Image" class="img-fluid"></a>
              <div class="hotel-room-body">
                <h3 class="heading mb-0"><a href="#">Classic Room</a></h3>
                <strong class="price">900.00 / per night</strong>
              <p class="pt-1"><a href="Reservation.jsp" class="btn-custom">Book Now <span class="icon-long-arrow-right"></span></a></p>
              </div>
            </div>
          </div>
            ...
            <div class="col-md-6 col-lg-4 mb-5">
            <div class="hotel-room text-center">
              <a href="#" class="d-block mb-0 thumbnail"><img src="images/room-5.jpg" alt="Image" class="img-fluid"></a>
              <div class="hotel-room-body">
                <h3 class="heading mb-0"><a href="#">Superior Room</a></h3>
                <strong class="price">2350.00 / per night</strong>
                <p class="pt-1"><a href="Reservation.jsp" class="btn-custom">Book Now <span class="icon-long-arrow-right"></span></a></p>
              </div>
            </div>
          </div>
            ...
            <div class="col-md-6 col-lg-4 mb-5">
            <div class="hotel-room text-center">
              <a href="#" class="d-block mb-0 thumbnail"><img src="images/room-6.jpg" alt="Image" class="img-fluid"></a>
              <div class="hotel-room-body">
                <h3 class="heading mb-0"><a href="#">Standard Room</a></h3>
                <strong class="price">1350.00 / per night</strong>
              <p class="pt-1"><a href="Reservation.jsp" class="btn-custom">Book Now <span class="icon-long-arrow-right"></span></a></p>
          ...
          <div class="col-md-6 col-lg-4 mb-5">
            <div class="hotel-room text-center">
              ...
              <div class="hotel-room-body">
                <h3 class="heading mb-0"><a href="#">Family Room</a></h3>
                <strong class="price">1400.00 / per night</strong>
              <p class="pt-1"><a href="Reservation.jsp" class="btn-custom">Book Now <span class="icon-long-arrow-right"></span></a></p>
              </div>
            </div>
          </div>
          <div class="col-md-6 col-lg-4 mb-5">
            <div class="hotel-room text-center">
              ...
              <div class="hotel-room-body">
                ...
                <strong class="price">755.00 / per night</strong>
              <p class="pt-1"><a href="Reservation.jsp" class="btn-custom">Book Now <span class="icon-long-arrow-right"></span></a></p>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-4 mb-5">
            <div class="hotel-room text-center">
              ...
              <div class="hotel-room-body">
                <h3 class="heading mb-0"><a href="#">Deluxe Room</a></h3>
                <strong class="price">1500.00 / per night</strong>
               <p class="pt-1"><a href="Reservation.jsp" class="btn-custom">Book Now <span class="icon-long-arrow-right"></span></a></p>
              </div>
            </div>
          </div>
          <div class="col-md-6 col-lg-4 mb-5">
            <div class="hotel-room text-center">
              ...
              <div class="hotel-room-body">
                ...
                <strong class="price">2200.00 / per night</strong>
              <p class="pt-1"><a href="Reservation.jsp" class="btn-custom">Book Now <span class="icon-long-arrow-right"></span></a></p> 
              </div>
            </div>
          </div>
